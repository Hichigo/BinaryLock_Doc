# BP\_LCDLock\_16Bit\_Door

* Lock inherited from **BP\_CoreBinaryLock**.
* The number of buttons by default (16 pieces).
* Added static mesh component (**SM\_LCDPanelMiddle**). There are 5 materials in this grid that show the number that is currently entered.
